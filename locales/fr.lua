local Translations = {
    weather = {
        ...
        invalid = 'Type de météo invalide, les types de météo valides sont : \nEXTRASUNNY CLEAR NEUTRAL OVERCAST CLOUDS CLEARING RAIN THUNDER SNOW BLIZZARD SNOWLIGHT XMAS HALLOWEEN ',
    ...
    help = {
        ...
        availableweather = 'Types de météo possible : extrasunny, clear, neutral, overcast, clouds, clearing, rain, thunder, snow, blizzard, snowlight, xmas & halloween',
